...
class AnimalChoiceWidget(QDialog):
    ...
    def initUI(self):
        self.setWindowTitle('Animal Choice Widget')
        ...
        self.animal_combo.setGeometry(90, 90, 281, 41)
        self.animal_combo.setStyleSheet("font: 75 14pt \"Sitka Text\";")

        for choice in self.choices:
            self.animal_combo.addItem(choice)
    ...
    def on_ok_button_clicked(self):
        self.selected_animal = self.animal_combo.currentText()
        self.accept()
